...
BEGIN
    ...
    INSERT INTO SCHEDULE (SC_TITLE, ID, SC_PLACE, SC_START, SC_END, SC_ALL_DAY, SC_CONTENT)
    VALUES (p_title, p_id, p_space, v_start_dt, v_end_dt, p_all_day, p_content);
...
--프로시저 수정 
--수정 내용
--sc_idx 자동 생성 제거, commit 제거 , sequence 생성

drop procedure sp_insert_schedule;
...
BEGIN
    ...
    VALUES (schedule_seq.nextval,p_title, p_id, p_space, v_start_dt, v_end_dt, p_all_day, p_content);
