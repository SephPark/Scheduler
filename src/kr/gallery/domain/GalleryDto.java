...
public class GalleryDto {
	...
	public String toString() {
		return "GalleryDto [g_idx=" + g_idx + ", g_title=" + g_title + ", id=" + id + ", g_content=" + g_content
				+ ", g_photo1=" + g_photo1 + ", g_photo2=" + g_photo2 + ", g_photo3=" + g_photo3 + ", g_reg_date="
				+ g_reg_date + ", g_modify_date=" + g_modify_date + "]";
	}
	public int getG_idx() {
		return g_idx;
	}
